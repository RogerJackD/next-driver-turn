...
export function ReportFiltersForm({ onSubmit, isLoading }: ReportFiltersFormProps) {
  ...
  const processSubmit = (data: ReportFiltersFormData) => {
    const filters: ReportFilters = {
      ...
      ...(data.driverId ? { driverId: Number(data.driverId) } : {}),
  ...
  const selectClass =
    'h-11 w-full rounded-md border border-gray-300 bg-white px-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500';
  const inputClass =
    'h-11 w-full rounded-md border border-gray-300 bg-white px-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500';
